ORI_FOLDER = "E:/aibianqu/notagen/xml"  # Replace with the path to your folder containing XML (.xml, .mxl, .musicxml) files
DES_FOLDER = "E:/aibianqu/notagen/abc_output"   # The script will convert the musicxml files and output standard abc notation files to this folder
